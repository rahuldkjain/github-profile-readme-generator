...
const Social = props => {
  return (
    <div className="section">
      ...
      <div className="container">
        <img
          src="https://img.icons8.com/metro/2x/globe.png"
          className="icon"
          alt="website"
        />
        <input
          id="website"
          placeholder="www.my_website.com"
          className="inputField lg"
          value={props.social.website}
          onChange={event => props.handleSocialChange("website", event)}
        />
      </div>
      <div className="container">
        <img
          src="https://img.icons8.com/ios/2x/angelist.png"
          className="icon"
          alt="angel"
        />
        <input
          id="angel"
          placeholder="AngelList Username"
          className="inputField lg"
          value={props.social.angel}
          onChange={event => props.handleSocialChange("angel", event)}
        />
      </div>
    </div>
  )
