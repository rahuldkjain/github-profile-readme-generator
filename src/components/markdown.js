...
const Markdown = props => {
  ...
  const DisplaySocial = props => {
    if (props.username) {
      return (
        <>
          {`<a href="${props.base}/${props.username}" target="blank"><img align="center" src="${props.icon}" alt="${props.username}" height="20" width="20" /></a>`}
          <br />
        </>
      )
    }
  ...
  const GithubStats = props => {
    ...
    if (props.show) {
      return (
        <>
          {`<p align="center"> <img src="${link}" alt="${props.github}" /> </p>`}
          <br />
          <br />
        </>
      )
    ...
    skills.forEach(skill => {
      if (props.skills[skill]) {
        listChosenSkills.push(
          `<img src="${icons[skill]}" alt="${skill}" width="20" height="20"/>`
        )
      }
    })
  ...
  return (
    <div id="markdown-content">
      ...
      <>
        <DisplaySocial
          base="https:/"
          icon="https://img.icons8.com/metro/2x/globe.png"
          username={props.social.website}
        />
      </>
      <>
        <DisplaySocial
          base="https://angel.co/u"
          icon="https://img.icons8.com/ios/2x/angelist.png"
          username={props.social.angel}
        />
      </>
