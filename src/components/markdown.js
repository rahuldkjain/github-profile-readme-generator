...
const Markdown = (props) => {
    ...
    return (
        <div id="markdown-content">
            ...
            <><DisplaySocial base='https://www.codechef.com/c' icon='https://cdn.jsdelivr.net/npm/simple-icons@3.1.0/icons/codechef.svg'
                username={props.social.codechef} /></>
            <><DisplaySocial base='https://www.hackerrank.com/c' icon='https://cdn.jsdelivr.net/npm/simple-icons@3.0.1/icons/hackerrank.svg'
                username={props.social.hackerrank} /></>
            <><DisplaySocial base='https://www.codeforces.com/c' icon='https://cdn.jsdelivr.net/npm/simple-icons@3.0.1/icons/codeforces.svg'
                username={props.social.codeforces} /></>
            <><DisplaySocial base='https://www.leetcode.com/c' icon='https://cdn.jsdelivr.net/npm/simple-icons@3.0.1/icons/leetcode.svg'
                username={props.social.leetcode} /></>
            <><DisplaySocial base='https://www.hackerearth.com/c' icon='https://cdn.jsdelivr.net/npm/simple-icons@3.0.1/icons/hackerearth.svg'
                username={props.social.hackerearth} /></>
            <><DisplaySocial base='https://www.geeksforgeeks.com/c' icon='https://cdn.jsdelivr.net/npm/simple-icons@3.0.1/icons/geeksforgeeks.svg'
                username={props.social.geeks_for_geeks} /></>
            <><DisplaySocial base='https://www.topcoder.com/c' icon='https://cdn.jsdelivr.net/npm/simple-icons@3.0.1/icons/topcoder.svg'
